...
class ScriptTable(BaseModel):
    ...
    name = models.CharField('设备类型', max_length=50, unique=True)  # 绑定设备类型唯一
    ...
    replyContent = models.CharField('加好友话术', max_length=255, default='')
    configType = models.CharField('配置类型', max_length=50, default='')
    addPeopleContent = models.TextField('发消息内容', default='')
